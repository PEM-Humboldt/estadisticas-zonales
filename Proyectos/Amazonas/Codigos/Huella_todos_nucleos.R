...
#
# Descripción: análisis multitemporal de la huella espacial humana region amazonas y todos los núcleos. implica manipulación manual para cambiar la corrida de los núcleos o de la región amazonía.
...
write_excel_csv2(Stat_values, paste0(dir_Resultados, "/IHEH_stats_NDFyB.csv"))
write_excel_csv2(Stat_reclass, paste0(dir_Resultados, "/IHEH_clases_NDFyB.csv"))

write_excel_csv2(Stat_values, paste0(dir_Resultados, "/IHEH_stats_Amazonas.csv"))
write_excel_csv2(Stat_reclass, paste0(dir_Resultados, "/IHEH_clases_Amazonas.csv"))
...
saveWidget(t1, file = file.path(dir_Resultados, "Estadísticas_IHEH_NDFyB.html"))
saveWidget(t1, file = file.path(dir_Resultados, "Estadísticas_IHEH_Amazonas.html"))
...
n<-read_csv2(paste0(dir_Resultados, "/IHEH_stats_NDFyB.csv"))
a<- read_csv2(paste0(dir_Resultados, "/IHEH_stats_Amazonas.csv"))
...
ggsave(file.path(dir_Resultados, "Promedio_IHEH_Nucleos _Region.png"), width = 15, height =  10, units="cm")
...
ggsave(file.path(dir_Resultados, "Porcentaje_Categorias_NDFyB.png"), width = 15, height =  10, units= "cm")
ggsave(file.path(dir_Resultados, "Porcentaje_Categorias_Amazonas.png"), width = 15, height =  10, units= "cm")
